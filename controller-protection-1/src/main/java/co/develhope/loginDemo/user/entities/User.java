...
public class User {
    ...
    public User(long id, String name, String surname, boolean isActive, String activationCode, String passwordResetCode, String email, String password, LocalDateTime jwtCreatedOn, Set<Role> roles) {
        this.id = id;
        this.name = name;
